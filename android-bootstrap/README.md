...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-lsus-teamcoach-teamcoachapp.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-lsus-teamcoach-teamcoachapp)

This repository contains the source code for the [teamcoach](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.lsus.teamcoach.teamcoachapp).

Please see the [issues](https://github.com.lsus.teamcoach.teamcoachapp/com-lsus-teamcoach-teamcoachapp/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about teamcoach? Ask away on the [com-lsus-teamcoach-teamcoachapp discussion forum](https://groups.google.com/forum/#!forum/com-lsus-teamcoach-teamcoachapp).

<a href="https://play.google.com/store/apps/details?id=com.lsus.teamcoach.teamcoachapp" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.lsus.teamcoach.teamcoachapp__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.lsus.teamcoach.teamcoachapp__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.lsus.teamcoach.teamcoachapp.R__) will now be renamed
...
signed with a different key.  Manually uninstall teamcoach from your device and
...
teamcoach is a result of a template project I've developed over the years as well as
...
teamcoach is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.lsus.teamcoach.teamcoachapp/com-lsus-teamcoach-teamcoachapp/contributors) on
...
[pull requests](https://github.com.lsus.teamcoach.teamcoachapp/com-lsus-teamcoach-teamcoachapp/pulls).
