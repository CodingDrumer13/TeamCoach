...
/**
 * Created by TeamCoach on 5/2/2015.
 */
public class CalendarDrillListFragment extends ItemListFragment<Drill> {
        ...
        if(parent.isEditClicked()){
            ...
            removeDrill.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if(drillList.size() == 0){
                        (CalendarDrillListFragment.this).parent.btnCalendarInfoAddSession.setVisibility(View.VISIBLE);
                    }
                    CalendarDrillListFragment.this.parent.refreshList();
                    dialog.cancel();
                }
            });
            ...
            drillInfoIntent.putExtra(DRILL_INFO_PARENT, "Calendar");
